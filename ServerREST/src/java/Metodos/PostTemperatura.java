...
public class PostTemperatura {
    ...
    public String setName(String content) {
        ...
        if(s.getSensornumero() != null && s.getTemperatura() != null){
            ...
            return "JSON valido, Temperatura: " + s.getTemperatura() + " registrada para o sensor: " + s.getSensornumero();
        } else {
            return "JSON invalido | Padrao exemplo: {\"temperatura\":\"38.94\",\"sensornumero\":\"1\"}";
        }
         }catch(JsonSyntaxException e){
            return "Nao e um JSON | Padrao exemplo: {\"temperatura\":\"38.94\",\"sensornumero\":\"1\"}";
        }
